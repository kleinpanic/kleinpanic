...
| --- | --- | --- | --- | --- | --- |
| [fblogin](https://github.com/kleinpanic/fblogin) | fblogin is a lightweight, framebuffer-based login manager for Debian. It replac… | C | MIT | [1.0.0](https://github.com/kleinpanic/fblogin/releases/tag/v1.0.0) | 2 |
...
| [GSD-OC](https://github.com/kleinpanic/GSD-OC) | GSD lifecycle orchestration as a native OpenClaw plugin — enforced research→pla… | TypeSc | MIT | [0.4.2](https://github.com/kleinpanic/GSD-OC/releases/tag/v0.4.2) | 1 |
| [lumos](https://github.com/kleinpanic/lumos) | Lumos—cross-platform CLI for backlight brightness control. Supports internal pa… | C | GPL-3.0 | — | 1 |
| [memory-spark](https://github.com/kleinpanic/memory-spark) | 15-stage RAG pipeline with dynamic reranker gating, RRF fusion, and asymmetric… | TypeSc | Apache-2.0 | [0.2.0](https://github.com/kleinpanic/memory-spark/releases/tag/v0.2.0) | 2 |
| [mission-control](https://github.com/kleinpanic/mission-control) | Real-time dashboard for monitoring and orchestrating OpenClaw agents. WebSocket… | TypeSc | — | — | 0 |
